...
export class MortgagesratesComponent {
  ...
  ngOnInit(): void {
    this.seo.updateSeo({
      ...
      description:
        'Calculate your mortgage repayments and explore how much you could borrow, monthly payments, stamp duty costs, overpayments, and more with our easy-to-use mortgage calculators.',
